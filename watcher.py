...
from make_site import build

class BuildSiteEventHandler(PatternMatchingEventHandler):
    """Build the site."""
...
if __name__ == "__main__":
    ...
    event_handler = BuildSiteEventHandler(ignore_patterns=["./_site", "./_site/*", "./.git", "./.git/*", "./venv/*"])
    observer = Observer()
